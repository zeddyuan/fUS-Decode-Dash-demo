...
![fUS-Decode-Dash Live Demo](figures/dashboard-demo.gif)

*Real-time clinical monitoring dashboard with fUS signal streaming, AI neural decoding, and clinical metrics*
